...
const API_BASE = 'https://debt-list-app.onrender.com';
...
async function createNewAccount(e) {
    ...
    try {
        ...
        const response = await fetch('https://debt-list-app.onrender.com/create-user', {
            method: 'POST',
            headers: { 
                'Content-Type': 'application/json'
            },
...
async function deleteUserFromAuth(uid) {
    try {
        ...
        const response = await fetch('https://debt-list-app.onrender.com/delete-user', {
            method: 'POST',
            headers: { 
                'Content-Type': 'application/json'
            },
